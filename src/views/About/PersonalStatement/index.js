...
1. 掌握一般编程语言的主要概念。理解原始类型和引用类型（对象）；理解变量的可变与不可变；理解类型、静态语言动态语言的区别，能看懂typescript；理解表达式和函数式编程；理解纯函数和副作用；理解垃圾回收等。理解算法复杂度。会用正则表达式。

1. 掌握面向对象编程思想。知道java和c++里类的结构，知道继承、多态、接口等概念，知道设计模式，熟练使用js的类，会用oop思维来设计程序（此网站的tictactoe游戏就使用了oop）。
...
1. 了解http请求的过程，了解cors、cookie等（此网站的用户系统使用了cookie）。
...
1. 会写框架下可复用的ui组件，可脱离第三方ui库。

1. 会对比理解vue和react，如：模板语法对比jsx、生命周期对比useEffect、类组件对比函数组件，更好适应前端发展。
***
